...
export type { ExistsOptions, FileEncoding, FsAsyncResult, ReadFileContent, ReadOptions, WriteFileContent, WriteOptions } from './fs/defines.ts';
...
export { appendFile, downloadFile, exists, readBlobFile, readTextFile, uploadFile } from './fs/opfs_ext.ts';
