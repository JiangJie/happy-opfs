...
- Installing from npm no longer requires a consumer-side `.npmrc` — `@std/path` is inlined into the npm build instead of resolving from the JSR registry
...
[2.3.1]: https://github.com/JiangJie/happy-opfs/compare/v2.3.0...v2.3.1
